    ...
    namespace hds
    {
        ...
        class mesh
        {
                ...
                const  half_edge_pointer* , const half_edge_pointer& >
            {
                ...
                vertex_vertex_iterator(const vertex_vertex_iterator& o) :
                    m_incident_vertex(o.m_incident_vertex)
                    , m_current(o.m_current)
                    , m_loop_counter(o.m_loop_counter)
                {
                ...
                vertex_vertex_iterator& operator=(const vertex_vertex_iterator& o)
                {
                    m_incident_vertex = o.m_incident_vertex;
                    m_current = o.m_current;
                    m_loop_counter = o.m_loop_counter;
                ...
                const  half_edge_pointer* , const half_edge_pointer& >
            {
                ...
                vertex_face_iterator(const vertex_face_iterator& o) :
                    m_incident_vertex(o.m_incident_vertex)
                    , m_current(o.m_current)
                    , m_loop_counter(o.m_loop_counter)
                {
                ...
                vertex_face_iterator& operator=(const vertex_face_iterator& o)
                {
                    m_incident_vertex = o.m_incident_vertex;
                    m_current = o.m_current;
                    m_loop_counter = o.m_loop_counter;
                ...
                const  half_edge_pointer* , const half_edge_pointer& >
            {
                ...
                face_face_iterator(const face_face_iterator& o) :
                    m_face(o.m_face)
                    , m_current(o.m_current)
                    , m_loop_counter(o.m_loop_counter)
                ...
                face_face_iterator& operator=(const face_face_iterator& o)
                {
                    m_face = o.m_face;
                    m_current = o.m_current;
                    m_loop_counter = o.m_loop_counter;
                ...
                const  half_edge_pointer* , const half_edge_pointer& >
            {
                ...
                face_vertex_iterator(const face_vertex_iterator& o) :
                    m_face(o.m_face)
                    , m_current(o.m_current)
                    , m_loop_counter(o.m_loop_counter)
                ...
                face_vertex_iterator& operator=(const face_vertex_iterator& o)
                {
                    m_face = o.m_face;
                    m_current = o.m_current;
                    m_loop_counter = o.m_loop_counter;
    ...
    class mesh_pointer_hash : public std::unary_function< std::pair < indexed_face_set::mesh::pointer, indexed_face_set::mesh::pointer >, size_t>
    {
        public:
            result_type operator()(const argument_type& v) const
            {
                ...
                return (std::hash<uint64_t>()((value & (ULLONG_MAX >> 1)) == 0 ? 0 : value));
            }
    };
