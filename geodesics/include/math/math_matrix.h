...
namespace math
{
	...
	inline void store44(float* __restrict address, const_float4x4_in m)
	{
	...
	inline void store43(float* __restrict address, const_float4x4_in m)
	{
		store4(address, m.r[0]);
		store4(address+4, m.r[1]);
		store4(address+8, m.r[2]);
	...
	inline float4x4 transpose(const_float4x4_in m)
	{
		float4x4 m1;
	...
	inline float4x4 inverse(const_float4x4_in m)
	{
		float4 tmp;
		float4 det;
		float4 minor0; 
	...
	inline float4 mul(float4 v, const_float4x4_in m)
	{
	...
	inline float4 mul(const_float4x4_in m, float4 v)
	{
		float4x4 trans = transpose(m);
		return mul(v, trans);
	}

	inline float4x4 mul(const_float4x4_in m1, const_float4x4_in m2)
	{
		float4x4 m;
	...
	inline float4x4 add(const_float4x4_in m1, const_float4x4_in m2)
	{
		float4x4 m;
	...
	inline float4x4 matrix44_sub(const_float4x4_in m1, const_float4x4_in m2)
	{
		float4x4 m;
	...
	inline float4x4 matrix44_mad(const_float4x4_in m1, const_float4x4_in m2, const_float4x4_in m3)
	{
