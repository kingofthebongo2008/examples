...
namespace math
{
    ...
    inline void extract_view_frustum(const_float4x4_in wvp, float frustum[24])
    {
        float4 v1;
        float4 v2;
        float4 v3;
    ...
    inline float4 transform3(float4 v, const_float4x4_in m)
    {
    ...
    inline float4 perspective_transform3(float4 v, const_float4x4_in m)
    {
    ...
    inline float4 project( float4 v, const_float4x4_in wvp, const view_port view_port)
    {
    ...
    inline float4 unproject( float4 v, const_float4x4_in inverse_wvp, const view_port view_port)
    {
        float	half_height	= (view_port.m_bottom - view_port.m_top) * 0.5f;
        float	half_width	= (view_port.m_right - view_port.m_left) * 0.5f;
    ...
    inline std::tuple<float, float> extract_near_far( const_float4x4_in p )
    {
        float a = p.m[3][2];
        float b = p.m[2][2];
