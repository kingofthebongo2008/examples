...
{ 
    ...
    inline float4 matrix_2_quaternion_ref(const_float4x4_in m)
    {
        float X = get_x( m.r[0] );
        float Y = get_y( m.r[1] );
        float Z = get_z( m.r[2] );
   ...
   // generates quaternion from rotational matrix
    inline float4 matrix_2_quaternion(const_float4x4_in m)
    {
    ...
    inline float4 matrix_2_quaternion_simd(const_float4x4_in m)
    {
        static const uint32_t	__declspec( align(16) )	mask_x[4]   = { 0xFFFFFFFF, 0, 0, 0 };
        static const float4 mask_one                                = { 1.0f, -1.0f, 0.0f, 0.0f};
        static const float4 mask_half                               = { 0.5f, 0.5f, 0.5f, 0.5f };
