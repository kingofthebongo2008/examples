...
namespace lscm
{
    ...
    {
        public:
        explicit shader_light_accumulation_cs ( ID3D11Device* device )
        {
            ...
            throw_if_failed<d3d11::create_pixel_shader>(device->CreateComputeShader(gx_shader_light_accumulation_cs, sizeof(gx_shader_light_accumulation_cs), nullptr, &m_shader));
            m_code = &gx_shader_light_accumulation_cs[0];
            m_code_size = sizeof(gx_shader_light_accumulation_cs);
        }
