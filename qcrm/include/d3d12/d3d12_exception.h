...
namespace d3d12
{
    ...
    class create_descriptor_heap_exception : public exception
    {
    public:
        create_descriptor_heap_exception(const HRESULT hr) : exception(hr)
        {
    ...
    class create_command_queue_exception : public exception
    {
    public:
        create_command_queue_exception(const HRESULT hr) : exception(hr)
        {

        }
    };

    class create_command_allocator_exception : public exception
    {
    public:
        create_command_allocator_exception(const HRESULT hr) : exception(hr)
        {

        }
    };

    class create_heap_exception : public exception
    {
    public:
        create_heap_exception(const HRESULT hr) : exception(hr)
        {
