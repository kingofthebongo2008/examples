declare module WebSharper {
    ...
    module InteropProxy {
        ...
        interface FuncWithRestProxy21<_T1, _T2> {
        }
        interface FuncWithRestProxy11<_T1, _T2, _T3> {
        }
        interface FuncWithRestProxy3<_T1, _T2, _T3, _T4> {
        }
        interface FuncWithRestProxy1<_T1, _T2, _T3, _T4, _T5> {
        }
        interface FuncWithRestProxy2<_T1, _T2, _T3, _T4, _T5, _T6> {
        }
        interface FuncWithRestProxy4<_T1, _T2, _T3, _T4, _T5, _T6, _T7> {
        }
