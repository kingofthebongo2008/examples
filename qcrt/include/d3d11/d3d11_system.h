...
namespace d3d11
{
    ...
    inline system_context create_system_context(HWND hwnd)
    {
        ...
        //auto flags = D3D11_CREATE_DEVICE_BGRA_SUPPORT;//D3D11_CREATE_DEVICE_DEBUGGABLE; // D3D11_CREATE_DEVICE_BGRA_SUPPORT;  //D3D11_CREATE_DEVICE_DEBUG | D3D11_CREATE_DEVICE_BGRA_SUPPORT;
