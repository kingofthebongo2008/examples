...
namespace d3d11
{
    ...
    //----------------------------------------------------------------------------------------------------------
    inline void ps_set_shader_resources(ID3D11DeviceContext* device_context, resource_slot slot, resource_count num_views, ID3D11ShaderResourceView ** shader_resource_view)
    {
        device_context->PSSetShaderResources( slot, num_views, shader_resource_view);
    }
    //----------------------------------------------------------------------------------------------------------
    inline void ps_set_shader_resources(ID3D11DeviceContext* device_context, resource_count num_views, ID3D11ShaderResourceView ** shader_resource_view)
    {
        ps_set_shader_resources( device_context, 0, num_views, shader_resource_view );
    }
    //----------------------------------------------------------------------------------------------------------
    inline void ps_set_shader_resources(ID3D11DeviceContext* device_context, ID3D11ShaderResourceView * shader_resource_view [] )
    {
    ...
    //----------------------------------------------------------------------------------------------------------
    inline void ps_set_shader_resources(ID3D11DeviceContext* device_context, resource_slot slot, ID3D11ShaderResourceView * shader_resource_view [] )
    {
    ...
    //----------------------------------------------------------------------------------------------------------
    inline void ps_set_shader_resources(ID3D11DeviceContext* device_context, resource_slot slot, ID3D11ShaderResourceView * resource_0, ID3D11ShaderResourceView * resource_1, ID3D11ShaderResourceView * resource_2 )
    {
        ID3D11ShaderResourceView * resources[3] = { resource_0 , resource_1, resource_2};
        ps_set_shader_resources( device_context, slot,  resources);
    }
    //----------------------------------------------------------------------------------------------------------
    inline void ps_set_shader_resources(ID3D11DeviceContext* device_context, resource_slot slot, ID3D11ShaderResourceView * resource_0, ID3D11ShaderResourceView * resource_1)
    {
        ID3D11ShaderResourceView * resources[2] = { resource_0 , resource_1};
        ps_set_shader_resources( device_context, slot,  resources);
    }
    //----------------------------------------------------------------------------------------------------------
    inline void ps_set_shader_resources(ID3D11DeviceContext* device_context, ID3D11ShaderResourceView * resource_0, ID3D11ShaderResourceView * resource_1, ID3D11ShaderResourceView * resource_2 )
    {
        ps_set_shader_resources(device_context, 0, resource_0, resource_1, resource_2 );
    }
    //----------------------------------------------------------------------------------------------------------
    inline void ps_set_shader_resources(ID3D11DeviceContext* device_context, ID3D11ShaderResourceView * resource_0, ID3D11ShaderResourceView * resource_1)
    {
    ...
    //----------------------------------------------------------------------------------------------------------
    inline void ps_set_shader_resource(ID3D11DeviceContext* device_context, resource_slot slot, ID3D11ShaderResourceView * shader_resource_view)
    {
