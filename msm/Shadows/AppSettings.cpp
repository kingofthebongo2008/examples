...
namespace AppSettings
{
    ...
    void Initialize(ID3D11Device* device)
    {
        ...
        SMFormat.Initialize(tweakBar, "SMFormat", "Shadows", "VSM/MSM Format", "Texture format to use for VSM or ESM shadow maps", SMFormat::SM32Bit, 2, SMFormatLabels);
        ...
        MSMMomentBias.Initialize(tweakBar, "MSMMomentBias", "Shadows", "MSM Moment Bias (x1000)", "Moment bias amount for MSM shadows", 0.0010f, 0.0000f, 100.0000f, 0.0010f);
