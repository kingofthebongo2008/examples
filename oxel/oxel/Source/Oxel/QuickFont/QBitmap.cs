...
namespace QuickFont
{
    public class QBitmap
    {
        ...
        /// </summary>
        public static unsafe bool EmptyAlphaPixel(BitmapData bitmapData, int px, int py)
        {
        ...
        /// <param name="srcPx"></param>
        /// <param name="srcPy"></param>
        /// <param name="srcW"></param>
        /// <param name="srcH"></param>
        /// <param name="px"></param>
        /// <param name="py"></param>
        public static void Blit(BitmapData source, BitmapData target, int srcPx, int srcPy, int srcW, int srcH, int px, int py)
        {
