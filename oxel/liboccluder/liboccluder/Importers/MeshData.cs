...
namespace Oxel
{
    ...
    public class MeshData
    {
        ...
        public void IndexArrays(out int[] verts, out int[] norms, out int[] texcoords) {
            ...
            foreach(Face f in Faces) {
                foreach(MeshPoint p in f.Points) {
                    v.Add(p.Vertex);
                    n.Add(p.Normal);
                    t.Add(p.TexCoord);
                }
    ...
    public struct MeshPoint
    {
        ...
        public override string ToString() { return String.Format("MeshPoint: {0},{1},{2}", Vertex, Normal, TexCoord); }
    }

    public class Tri
    {
        public MeshPoint P1, P2, P3;
        public Tri()
        {
            P1 = new MeshPoint();
            P2 = new MeshPoint();
        ...
        public Tri(MeshPoint a, MeshPoint b, MeshPoint c)
        {
            P1 = a;
            P2 = b;
            P3 = c;
