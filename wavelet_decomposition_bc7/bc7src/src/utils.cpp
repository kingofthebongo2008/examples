...
/*
//ATI weight
#define RED_WEIGHT  0.3086
#define GREEN_WEIGHT 0.6094
#define BLUE_WEIGHT 0.0820
*/

// Read the INSTRUCTIONS.txt file on how to use these quantisation weights

#define RED_WEIGHT  0.25
#define GREEN_WEIGHT 0.5
#define BLUE_WEIGHT 0.25

/*
#define RED_WEIGHT  0.21
#define GREEN_WEIGHT 0.58
#define BLUE_WEIGHT 0.21
*/

/*
#define RED_WEIGHT  0.23
#define GREEN_WEIGHT 0.54
#define BLUE_WEIGHT 0.23
*/

/*
#define RED_WEIGHT  0.333
#define GREEN_WEIGHT 0.333
#define BLUE_WEIGHT 0.333
*/
...
double Utils::metric4(const Vec4& a, const Vec4& b)
{
	...
	if (AVPCL::flag_nonuniform || AVPCL::flag_nonuniform_ati)
	{
		...
		{
			rwt = RED_WEIGHT; gwt = GREEN_WEIGHT; bwt = BLUE_WEIGHT;
		}
